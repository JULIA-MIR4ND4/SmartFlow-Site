      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <FadeIn>
          <div className="text-center max-w-2xl mx-auto mb-14">
            ...
            <h2
              className="font-display text-3xl lg:text-4xl font-bold mb-4 leading-tight text-slate-900 dark:text-white"
            >
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            >
              ...
              <div className="text-left">
                <div className="text-xs mb-0.5 text-slate-500">WhatsApp</div>
                <div className="font-semibold text-slate-900 dark:text-white">{WHATSAPP_DISPLAY}</div>
              </div>
            </a>
            ...
            >
              ...
              <div className="text-left">
                <div className="text-xs mb-0.5 text-slate-500">Instagram</div>
                <div className="font-semibold text-slate-900 dark:text-white">{INSTAGRAM_HANDLE}</div>
              </div>
            </a>
          </div>
        </FadeIn>
