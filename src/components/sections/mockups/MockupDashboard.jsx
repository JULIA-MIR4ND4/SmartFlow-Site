  ...
  return (
    <div className="flex w-full h-full bg-[#0F172A] text-slate-300">
      ...
      <div className="flex-1 p-4 overflow-hidden flex flex-col gap-2.5">
        <div className="text-[9px] text-slate-500">SmartFlow App / Dashboard</div>
        ...
        <div className="grid grid-cols-3 gap-2">
          {STAT_CARDS.map(({ icon: Icon, value, label }) => (
            <div key={label} className="bg-white/5 rounded-lg p-2.5 border border-white/10">
              ...
              <div className="text-[8px] text-slate-500 leading-tight mt-0.5">{label}</div>
            </div>
          ))}
        </div>
        ...
        <div className="grid grid-cols-2 gap-2 flex-1">
          <div className="bg-white/5 rounded-lg p-2.5 border border-white/10 flex flex-col">
            <div className="text-[8px] text-slate-400 mb-1">Vendas em litros no tap por mês</div>
          ...
          <div className="bg-white/5 rounded-lg p-2.5 border border-white/10 flex items-center gap-3">
            <div>
              <div className="text-[8px] text-slate-400 mb-1.5">Vendas PDV por categoria</div>
              <div
        ...
        <div className="grid grid-cols-2 gap-2">
          ...
          <div className="bg-white/5 rounded-lg p-2.5 border border-white/10">
            ...
            <div className="text-[7px] text-slate-500 mb-1.5">Novas TAGs — Mês atual até o dia de hoje</div>
        ...
        <div className="grid grid-cols-2 gap-2">
          <div className="bg-white/5 rounded-lg p-2.5 border border-white/10">
            ...
            <div className="text-[7px] text-slate-600 border-t border-white/5 pt-1">Cliente</div>
          </div>
          <div className="bg-white/5 rounded-lg p-2.5 border border-white/10">
            <div className="text-[8px] text-slate-400 mb-1">Top 10 consumos no tap do mês</div>
            <div className="flex text-[7px] text-slate-600 border-t border-white/5 pt-1 gap-3">
              <span>Ranking</span>
              <span>Cliente</span>
