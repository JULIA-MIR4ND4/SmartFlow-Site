  ...
  return (
    ...
    >
      <div id={feature.id} className={`order-1 ${isReversed ? "lg:order-2" : "lg:order-1"} p-6 sm:p-7 lg:p-8 scroll-mt-24`}>
        ...
        <p className="mt-3 max-w-2xl text-sm leading-7 text-slate-600 sm:text-[15px] dark:text-slate-400">{feature.description}</p>
        <div className="mt-6">
          <h4 className="text-[10px] font-semibold uppercase tracking-[0.3em] text-brand dark:text-[#3B82F6]">PRINCIPAIS AÇÕES DISPONÍVEIS</h4>
